<x-app-layout title="Actualizar anime">
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <label class="block text-sm">
                    ...
                    <input
                        ...
                        placeholder="Ingrese El titulo" id="Titulo" name="Titulo" value="{{$anime->Titulo}}">
                ...
                <label class="block text-sm">
                    ...
                    <input
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Ingrese otros nombres si es que existen" id="OtrosNombres" name="OtrosNombres" value="{{$anime->OtrosNombres}}">
                ...
                <label class="block text-sm">
                    ...
                    <input
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Ingrese la Sinopsis" id="Sinopsis" name="Sinopsis"  value="{{$anime->Sinopsis}}">
                ...
                <label class="block text-sm">
                    ...
                    <input
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Ingrese el tipo" id="Tipo" name="Tipo"  value="{{$anime->Tipo}}">
                ...
                <label class="block text-sm">
                  ...
                  <input
                      class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                      placeholder="Ingrese el año de lanzamiento" id="YearLanzamiento" name="YearLanzamiento"  value="{{$anime->YearLanzamiento}}">
                ...
                <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    placeholder="Ingrese el estudio de animación" id="EstudioAnimacion" name="EstudioAnimacion"  value="{{$anime->EstudioAnimacion}}">
                ...
                <label class="block text-sm">
                  ...
                  <input
                      class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                      placeholder="Ingrese Si si es subtitulado" id="Subtitulado" name="Subtitulado"  value="{{$anime->Subtitulado}}">
                  ...
                  <label class="block text-sm">
                    ...
                    <input
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Ingrese Si si es doblado" id="Doblado" name="Doblado"  value="{{$anime->Doblado}}">
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            placeholder="Ingrese iframe de youtube" id="Trailer" name="Trailer"  value="{{$anime->Trailer}}">
                    ...
                    <label class="block text-sm">
                        ...
                        <input
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            placeholder="Ingrese iframe de youtube" id="Calificacion" name="Calificacion"  value="{{$anime->Calificacion}}">
                ...
                <div class="mt-2">
                  ...
                  <select id="country" name="generos[]" multiple autocomplete="country-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300">
                    ...
                    <option value="{{$item->id}}" {{ in_array($item->id, $generosAsignados) ? 'selected' : '' }}>{{$item->Nombre}}</option>
                    @endforeach
                  </select>
