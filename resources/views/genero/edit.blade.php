<x-app-layout title="Actualziar Genero">
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <label class="block text-sm">
                    ...
                    <input
                        ...
                        placeholder="Ingrese el nombre del Articulo" id="Nombre" name="Nombre" value="{{$genero->Nombre}}">
                ...
                <div class="flex mt-6 text-sm ">
                    <a href="{{route('genero.index')}}" class=" px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-purple">
