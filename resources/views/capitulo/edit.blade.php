<x-app-layout title="Actualizar Capitulo">
    <div class="container grid px-6 mx-auto">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            Actualizar Capitulo {{$capitulo->Nombre}} de la temporada "{{$temporada->Nombre}}" de {{$temporada->anime->Titulo}} 
        </h2>
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <label class="block text-sm">
                    ...
                    <input
                        ...
                        placeholder="Ingrese el nombre del capitulo" id="Nombre" name="Nombre" value="{{$capitulo->Nombre}}">
                ...
                <label class="block text-sm">
                    ...
                    <input
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Ingrese el numero del capitulo " id="Numero" name="Numero" value="{{$capitulo->Numero}}">
                ...
                <label class="block text-sm">
                    ...
                    <input
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Ejemplo 23 min" id="Duracion" name="Duracion" value="{{$capitulo->Duracion}}">
                ...
                <label class="block text-sm">
                    ...
                    <input
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Ingrese fecha YYYY-MM-DD" id="FechaLanzamiento" name="FechaLanzamiento" value="{{$capitulo->FechaLanzamiento}}">
